...
return function(player, mapSeed)
    ...
    local function drawChunks(self, box)
        ...
        for tintName, spriteBatch in pairs(spriteBatches) do
            local tint = config.terrain.tints[tintName]
            love.graphics.setColor(tint.r, tint.g, tint.b, 1)
